...
class DetailsVC: UIViewController, UIImagePickerControllerDelegate,UINavigationControllerDelegate{
    ...
    override func viewDidLoad() {
        ...
        if choosenPainting != "" {
            //Core DATA
            saveButton.isHidden = true   //butonu gorunmez yapar.
            
                   let appDelegate = UIApplication.shared.delegate as! AppDelegate
                   let context = appDelegate.persistentContainer.viewContext
                   let fetchRequest = NSFetchRequest<NSFetchRequestResult>(entityName: "Paintings")
                    let idString = choosenPaintingId?.uuidString
                    fetchRequest.predicate = NSPredicate(format: "id = %Q", idString!) // sabit kuraldir yazilis sekli.Filtreleme islemi.
        ...
        imageView.addGestureRecognizer(imageTapRegocnizer)
